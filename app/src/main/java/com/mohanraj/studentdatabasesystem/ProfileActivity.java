...
public class ProfileActivity extends AppCompatActivity {
    ...
    TextView profileName, profileEmail, profileUsername, profilePassword, profileDepartment, profileSection;
    ...
    public void showAllUserData(){
        ...
        String sectionUser = intent.getStringExtra("section");
        ...
        profileSection.setText(sectionUser);
    }
        ...
        checkUserDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    String sectionFromDB = snapshot.child(userUsername).child("section").getValue(String.class);
